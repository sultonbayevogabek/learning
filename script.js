...
const createUserFormI = document.querySelector("#create-form");
const firstNameInputI = createUserForm.querySelector("#first_name");
const lastNameInputI = createUserForm.querySelector("#last_name");
const emailInputI = createUserForm.querySelector("#email");
const birthdateInputI = createUserForm.querySelector("#birthdate");
const usernameInputI = createUserForm.querySelector("#username");
const phoneInputI = createUserForm.querySelector("#phone");
const messageI = createUserForm.querySelector(".message");
...
createUserForm.addEventListener("submit", async (e) => {
  ...
  await getUserList();
  message.innerHTML = `<div class="alert text-center ${
    response.message === "New user created" ? "alert-success" : "alert-warning"
